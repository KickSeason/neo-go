...
type DAO interface {
	...
	GetNextContractID() (uint32, error)
	...
	PutNextContractID(id uint32) error
...
func (dao *Simple) GetNextContractID() (uint32, error) {
...
func (dao *Simple) PutNextContractID(id uint32) error {
	key := storage.SYSContractID.Bytes()
	data := make([]byte, 4)
